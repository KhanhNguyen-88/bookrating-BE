...
import com.khanhvan.book_rating.DTO.PageResponse;
...
public class BookController
{
    ...
    @GetMapping("/get-book-unapprove/{userId}")
    public ApiResponse<List<BookResponse>> geBookUnApproveByUserId(@PathVariable Integer userId)
    {
        ApiResponse<List<BookResponse>> apiResponse = new ApiResponse<>();
        apiResponse.setCode(200);
        apiResponse.setResult(bookService.getBookUnapproveByUserId(userId));
        return apiResponse;
    }
    ...
    @GetMapping("admin-cancel/{bookId}")
    public ApiResponse<?> cancelBook(@PathVariable Integer bookId){
        bookService.cancelBook(bookId);
        ApiResponse<?> apiResponse = new ApiResponse<>();
        apiResponse.setCode(200);
        apiResponse.setMessage("Hủy sách thành công");
        return apiResponse;
    }
    ...
    public ApiResponse<List<BookResponse>> getAllBook(){
        ApiResponse<List<BookResponse>> apiResponse = new ApiResponse<>();
        apiResponse.setCode(200);
        apiResponse.setResult(bookService.getAllBook());
        return apiResponse;
    }
    @GetMapping("/get-book-relation")
    public ApiResponse<List<BookResponse>> getBookRelation (@RequestParam String author, @RequestParam List<String> categoryNames){
        ApiResponse<List<BookResponse>> apiResponse = new ApiResponse<>();
        apiResponse.setResult(bookService.findBokHasRelationship(author, categoryNames));
        apiResponse.setCode(200);
        return apiResponse;
    }
}