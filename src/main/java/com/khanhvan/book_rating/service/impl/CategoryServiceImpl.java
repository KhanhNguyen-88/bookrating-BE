...
import com.khanhvan.book_rating.mapper.CategoryMapper;
...
import com.khanhvan.book_rating.repository.CategoryRepository;
...
public class CategoryServiceImpl implements CategoryService
{
    ...
    public int updateCategory(CategoryRequest categoryRequest) {
       return categoryRepository.updateCateById(categoryRequest.getCateName(), categoryRequest.getCateDescription(), categoryRequest.getId());
    }
